...
def sampleAPI():
    #API Endpoint Usage: Returns top five day over day values for the tickers and range value passed in as a parameter 


    # Authenticate users using basic authentication. Hashed usernames and passwords are stored in a dictionary in user.properties
